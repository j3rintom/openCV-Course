...
cap.set(10,150)#id=10 for brightness of camera

myColors = [[5,107,0,19,255,255],[133,56,0,159,156,255],[57,76,0,100,255,255],[90,48,0,118,255,255]]
myColorValues = [[51,153,255], #in the form BGR not RGB
                 [255,0,255],
                 [0,255,0],
                 [255,0,0]]
...
def getContour(img) :  #for setting contours i.e. boundaries
    ...
    for cnt in contours:
        ...
        if area>500:  #filtering contours
            #cv2.drawContours(imgResult, cnt, -1, (255, 0, 0), 3) #drawing contours
